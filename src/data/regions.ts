...
export const isValidSource = (source?: MetricSource | null): source is MetricSource => {
  return source !== null && source !== undefined && typeof source.sourceName === 'string' && typeof source.sourceUrl === 'string';
};
