...
export const translations = {
  'en-us': {
    ...
    calculator: {
      ...
      taxSavings: 'Tax Savings on Purchase',
      taxSavingsTooltip: 'Estimate based on average regional installation costs. Actual savings may vary depending on the installer\'s specific price structure (net vs. gross).',
  ...
  'de-de': {
    ...
    calculator: {
      ...
      taxSavings: 'Steuerersparnis beim Kauf',
      taxSavingsTooltip: 'Schätzung basierend auf durchschnittlichen regionalen Installationskosten. Die tatsächliche Ersparnis kann je nach Preisstruktur des Installateurs (Netto vs. Brutto) variieren.',
  ...
  'fr-fr': {
    ...
    calculator: {
      ...
      taxSavings: 'Économies d’impôt à l’achat',
      taxSavingsTooltip: 'Estimation basée sur les coûts d\'installation régionaux moyens. Les économies réelles peuvent varier selon la structure de prix de l\'installateur (net vs brut).',
